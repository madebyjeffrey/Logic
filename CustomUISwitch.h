...
@interface CustomUISwitch : UIControl 
{
	...
	NSString *switchForeground, *switchON, *switchOFF;
	
}

@property (nonatomic, assign, readwrite) id delegate;

@property (nonatomic, retain) NSString *switchForeground;
@property (nonatomic, retain) NSString *switchON;
@property (nonatomic, retain) NSString *switchOFF;
